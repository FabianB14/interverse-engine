...
// Circular with MenuScene (Menu -> Join -> Menu) — safe: only referenced
// inside callbacks, never during module evaluation.
...
export class JoinScene extends Scene {
  ...
  protected override onEnter(): void {
    ...
    // On-screen keypad: 31 characters + backspace, 8 per row.
    const perRow = 8;
    const keyW = 76;
    const keyH = 84;
    const keyGap = 10;
